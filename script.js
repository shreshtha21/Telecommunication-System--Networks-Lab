...
document.getElementById('btn-transmit').addEventListener('click', () => {
    ...
    function showNextColor() {
        ...
        txInterval = setTimeout(() => {
            ...
            blackScreen.style.padding = '0';
            blackScreen.style.border = 'none';
            blackScreen.style.zIndex ='999999';
            blackScreen.innerHTML = '';
            txDiv.innerHTML = '';
            txDiv.appendChild(blackScreen);
            txInterval = setTimeout(() => {showNextColor();}, 100);}, 1100);
    }
    showNextColor();
});
